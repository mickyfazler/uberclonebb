    ...
    <DrawerContentScrollView {...props} >
      ...
      <View style={{backgroundColor: '#212121', padding: 15}}>
        ...
        <View style={{
          ...
          <View>
            <Text style={{color: 'white', fontSize: 24}}>Micky Fazler</Text>
        ...
        { /* Do more */}
        <Pressable
          onPress={() => {console.warn('Do more with account')}}>
      ...
      <Pressable onPress={() => { Auth.signOut() }}>
        <Text style={{padding: 5, paddingLeft: 20,fontWeight:'bold',color:'red',fontSize:20}}>Logout</Text>
      </Pressable>
